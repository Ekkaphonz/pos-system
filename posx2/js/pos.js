/* ============================================================
   FILE: js/pos.js
   Product list, cart state, stock checking, cart rendering
   ============================================================ */
...
/* ── Product Data ───────────────────────────────────────── */
// Each product: id, name, price (KIP), icon, colours, defaultStock
const PRODUCTS = [
...
function addToCart(productId) {
  ...
  // Check available stock (stock minus what's already in cart)
  if (cartQty >= stock) {
  ...
  renderCart();
  buildMenu(); // refresh stock labels
  updateSummary();
}
...
/* ── Calculate Cart Subtotal (pre-VAT) ─────────────────── */
...
/* ── Get Cart Items as Array (for saving) ───────────────── */
...
function updateSummary() {
  ...
  updateChange(); // recalculate change too
}
...
document.addEventListener('DOMContentLoaded', () => {
  initStock(PRODUCTS); // make sure all products have stock records
  buildMenu();
  renderCart();
  updateSummary();
});